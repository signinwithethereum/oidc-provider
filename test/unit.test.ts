...
describe('parseAccountId', () => {
  it('parses a valid eip155 account ID', () => {
    const result = parseAccountId('eip155:1:0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045')
    expect(result.chainId).toBe(1)
    expect(result.address).toBe(getAddress('0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045'))
  })
